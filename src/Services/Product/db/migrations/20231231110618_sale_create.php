...
final class SaleCreate extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change(): void
    {
        ...
        $table->addColumn('published', 'boolean', ['default'=>true])
            ...
            ->addColumn('sale_amount_quatity', 'decimal', ['null'=>true])
            ->addColumn('sale_amount_paid', 'decimal', ['null'=>true])
            ->addColumn('statussale_id', 'integer', ['null'=>true])
            ->addForeignKey('statussale_id', 'statussale', 'id', ['delete'=>'SET NULL', 'update'=> 'NO_ACTION'])
