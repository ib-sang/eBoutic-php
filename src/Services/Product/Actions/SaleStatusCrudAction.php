...
use App\Services\Product\Table\StatusSaleTable;
...
class SaleStatusCrudAction extends CrudAction
{
    ...
    protected function getValidator($request): Validator
    {
        $validator = parent::getValidator($request)
            ->required('status', 'enterprises_id', 'users_id')
            ->notEmpty('status', 'enterprises_id', 'users_id');
        return $validator;
    }
