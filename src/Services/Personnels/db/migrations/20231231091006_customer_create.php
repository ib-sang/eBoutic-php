...
final class CustomerCreate extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change(): void
    {
        ...
        $table->addColumn('salaire', 'integer', ['null' =>true])
            ...
            ->addColumn('users_add', 'integer', ['null'=>true])
            ->addForeignKey('users_add', 'users', 'id', ['delete'=>'SET NULL', 'update'=> 'NO_ACTION'])
            ->create();
    }
}
